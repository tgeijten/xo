...
namespace xo
{
	struct XO_API prop_node_serializer_xml : public prop_node_serializer
	{
		...
		prop_node_serializer_xml( const prop_node& pn, error_code* ec = nullptr, const path& file_folder = path() ) : prop_node_serializer( pn, ec, file_folder ) {}
		prop_node_serializer_xml( prop_node& pn, error_code* ec = nullptr, const path& file_folder = path() ) : prop_node_serializer( pn, ec, file_folder ) {}
