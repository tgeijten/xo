...
namespace xo
{
	...
	public:
		...
		const string& to_string() const { return data_; }
	...
	inline bool operator<( const path& p1, const path& p2 ) { return p1.to_string() < p2.to_string(); }

	inline string to_str( const path& p ) { return p.to_string(); }
